...
.PHONY: test
test:
	PYTHONPATH=$(PYTHONPATH) poetry run pytest -c pyproject.toml --cov-report=html --cov=opensr_degradation tests/
...
check-safety:
	...
	poetry run bandit -ll --recursive opensr_degradation tests
